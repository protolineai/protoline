...
- `login`: explain that first-time setup is handled by `npx -y @protoline/protoline bootstrap`, and stale credentials can be refreshed with `npx -y @protoline/protoline login`.
